...
void main() {
    ...
    gl_FragColor = vec4(colorMap, 1.);
            ...
            <div id="carousel" class="carousel">
                ...
                <a href="#carousel" class="carousel-control-prev" role="button" onclick="prev()">back</a>
                <a href="#carousel" class="carousel-control-next" role="button" onclick="next()">next</a>
            </div>
        </section>
